...
final class CartLinesTest extends TestCase
{
    ...
    public function testRemoveLineExists()
    {
        $cartLines = new CartLines([
            new CartLine(
                new CartId('1'),
        ...
        $cartLines->removeLine(new ProductId('5'));

        $this->assertCount(1, $cartLines->items());
    }

    public function testRemoveLineNotExists()
    {
        ...
        $cartLines->removeLine(new ProductId('7'));
    }
}